...
<body class="main">
	...
	<div id="box_autoplay">
    	<div class="list">
        	<ul>
            	<li><img src="${pageContext.request.contextPath}/client/images/mianbu.jpg" width="500" height="335" /></li>
            	<li><img src="${pageContext.request.contextPath}/client/images/toufa3.jpg" width="500" height="335" /></li>
            	<li><img src="${pageContext.request.contextPath}/client/images/shenti3.jpg" width="300" height="335" /></li>
            	<li><img src="${pageContext.request.contextPath}/client/images/yanbu4.jpg" width="500" height="335" /></li>
            	<li><img src="${pageContext.request.contextPath}/client/images/shenti4.jpg" width="300" height="335" /></li>
        	</ul>
    	</div>
	</div>
	<!-- 图书商场首页轮播图  end -->	
