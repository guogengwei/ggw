...
<div id="divmenu">
		<a href="${pageContext.request.contextPath}/showProductByPage?category=lianbu">脸部</a> 
		<a href="${pageContext.request.contextPath}/showProductByPage?category=shoubu">手部</a> 
		<a href="${pageContext.request.contextPath}/showProductByPage?category=toufa">头发</a> 
		<a href="${pageContext.request.contextPath}/showProductByPage?category=yanbu">眼部</a> 
		<a href="${pageContext.request.contextPath}/showProductByPage?category=shentihuli">身体护理</a>
